...
//typedef char T_Emp[MAX] ; //utilisez d'abord ce type puis, remplacez le par celui ci dessous ()
...
typedef enum T_Jour {lundi,mardi,mercredi,jeudi,vendredi,samedi,dimanche}T_Jour;
typedef enum T_Mois {janvier,fevrier,mars,avril,mai,juin,juillet,aout,septembre,octobre,novembre,decembre}T_Mois;
